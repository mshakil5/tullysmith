            ...
            <div class="card-body">
                ...
                <div class="mb-4 p-3 rounded" style="background:#f8fafc;border:1px solid #e2e8f0;">
                    ...
                    @if($todayJobs->isEmpty())
                        <p class="text-muted text-center mb-0 py-2" style="font-size:0.85rem;">No jobs scheduled for this day</p>
                    @else
                        ...
                        <a href="{{ route('serviceJob.show', $tj['service_job_id']) }}" class="text-decoration-none">
                            <div class="d-flex justify-content-between align-items-start p-2 rounded mb-2" style="background:#fff;border:1px solid #e2e8f0;">
                                <div>
                                    ...
                                    @if($tj['address'])
                                    <p class="mb-0 text-muted" style="font-size:0.75rem;"><i class="ri-map-pin-line me-1"></i>{{ $tj['address'] }}</p>
                                    @endif
                                </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        <div class="col-12" id="myModalNoteRow">
    ...
    <script>
        $(function () {
            ...
            if (document.getElementById('calendar')) {
                ...
                var calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
                    ...
                    eventClick: function(info) {
                        ...
                        $('#modalDate').text(d.toLocaleDateString('en-GB', {
                            day: '2-digit',
                            month: 'long',
                            year: 'numeric'
                        }));
            ...
            if (document.getElementById('myCalendar')) {
                ...
                var myAssignments = @json($myAssignments);
                ...
                var myCalendar = new FullCalendar.Calendar(document.getElementById('myCalendar'), {
                    ...
                    eventClick: function (info) {
                        ...
                        var d = new Date(p.assigned_date + 'T00:00:00');
                        $('#myModalDate').text(d.toLocaleDateString('en-GB', {
                            day: '2-digit',
                            month: 'long',
                            year: 'numeric'
                        }));
