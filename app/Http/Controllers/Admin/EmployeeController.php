...
class EmployeeController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $users = User::select(['id', 'name', 'email', 'phone', 'status', 'primary_contact'])->where('user_type', 1)->orderByDesc('id');
                    ...
                    return '
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><button class="dropdown-item deleteBtn" data-delete-url="' . route('employee.delete', $row->id) . '" data-method="DELETE" data-table="#userTable"><i class="ri-delete-bin-fill me-2"></i>Delete</button></li>
                          </ul>
                        </div>';
                })
